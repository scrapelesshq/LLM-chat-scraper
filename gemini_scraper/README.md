# Gemini Scraper (LLM-chat-scraper)

Scraper for collecting structured conversation data from **Gemini** using the official **Scrapeless Cloud Browser SDK**.
...
## Important
After configuring `.env`, you need to edit `src/gemini.ts` to replace placeholder values:
