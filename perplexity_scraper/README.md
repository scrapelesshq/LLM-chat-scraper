# Perplexity Scraper (LLM-chat-scraper)

Scraper for collecting structured conversation data from **Perplexity** using the official **Scrapeless Cloud Browser SDK**.
...
## Important
After configuring `.env`, you need to edit `src/perplexity.ts` to replace placeholder values:
